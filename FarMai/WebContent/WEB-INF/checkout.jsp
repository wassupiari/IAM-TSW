...
<body>
    <div class="grid-container">
        ...
        <form action="CartControl?action=buy" method="post" onsubmit="event.preventDefault(); validate(this)">
            <div class="container">
                <div class="transparentCard">
                    ...
                    <div class="inputBox">
                        ...
                        <input id="destinatario" name="destinatario" type="text" maxlength="30" required autocomplete="off" placeholder="destinatario">
                        <label id="destinatarioLabel" for="destinatario">Insert addressee:</label>
                    </div>
                    <div class="inputBox">
                        <input name="note" type="text" maxlength="100" autocomplete="off" placeholder="Insert notes...">
